<div class="" x-data="app"  x-init=" await get_address(); await get_balance()">
    <header>
        ...
        @unless (session('user'))
            <section>
                <a href="login" wire:navigate>
                    <div class="bg-white p-6  shadow-md text-lg text-slate-600 mt-3 rounded-lg flex items-center "
                        x-transition>
    ...
    <footer
        ...
        <span class="hover:text-green-400"> <a href="/" wire:navigate><svg xmlns="http://www.w3.org/2000/svg"
                    fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                </svg></a>
        </span>
        <span class="hover:text-green-400"><a href="/card" wire:navigate> <svg xmlns="http://www.w3.org/2000/svg"
                    fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Z" />
                </svg></a></span>

        <span class="hover:text-green-400"> <a href="/reward" wire:navigate><svg xmlns="http://www.w3.org/2000/svg"
                    fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8">
                    <path stroke-linecap="round" stroke-linejoin="round"
                ...
                async get_balance() {
                    ...
                    const STABLE_TOKEN_ADDRESS = "0x874069fa1eb16d44d622f2e0ca25eea172369bc1";
                     const  address = this.address;
                             ...
                             //'0x99A03CF527acc798585c025068bBBa0B9e645347';
                   ...
                   //await this.get_address();
                     ...
                     let balance ="";
                        ...
                        balance= await checkCUSDBalance(publicClient, address); // In Ether unit
